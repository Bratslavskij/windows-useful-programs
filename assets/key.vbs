...
WinProductName = "Windows Current Version: " & WshShell.RegRead(regKey & "ProductName") & vbNewLine
WinProductID = "Windows Product ID: " & WshShell.RegRead(regKey & "ProductID") & vbNewLine
WinProductKey = ConvertToKey(DigitalProductId)
ProductKeyLabel ="Windows Product Key: " & WinProductKey
WinProductID = WinProductName & WinProductID & ProductKeyLabel
MsgBox(WinProductID)
